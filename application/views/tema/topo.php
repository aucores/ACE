...
<li class=""><a title="" href="<?php echo site_url();?>/ACE/minhaConta"><i class="icon icon-star"></i> <span class="text">Minha Conta</span></a></li>
<li class=""><a title="" href="<?php echo site_url();?>/mine"><i class="icon icon-eye-open"></i> <span class="text">Área do Cliente</span></a></li>
<li class="pull-right"><a href="https://github.com/aucores/ACE" target="_blank"><i class="icon icon-asterisk"></i> <span class="text">Versão: <?php echo $this->config->item('app_version'); ?></span></a></li>
<li class=""><a title="" href="<?php echo site_url();?>/ACE/sair"><i class="icon icon-share-alt"></i> <span class="text">Sair do Sistema</span></a></li>
...
<!--start-top-serch-->
<div id="search">
<form action="<?php echo base_url()?>index.php/ACE/pesquisar">
...
<li><a href="<?php echo base_url()?>index.php/ACE/emitente">Emitente</a></li>
<?php } ?>
...
<li><a href="<?php echo base_url()?>index.php/ACE/backup">Backup</a></li>
<?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
<div id="footer" class="span12"> <a href="https://github.com/aucores/ACE" target="_blank"><?php echo date('Y'); ?> &copy; ACE  @aucores </a></div>
</div>
<!--end-Footer-part-->

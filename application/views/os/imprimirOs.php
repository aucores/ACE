                ...
                <div class="invoice-head" style="margin-bottom: 0">
                    ...
                    <table class="table table-condensed" style="">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/ACE/emitente">Configurar</a><<<</td>
                            </tr>
                            <?php } else {?>
                            <tr>

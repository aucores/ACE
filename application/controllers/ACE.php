...
class ACE extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['ordens'] = $this->ACE_model->getOsAbertas();
        $this->data['produtos'] = $this->ACE_model->getProdutosMinimo();
        $this->data['os'] = $this->ACE_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->ACE_model->getEstatisticasFinanceiro();
        $this->data['menuPainel'] = 'Painel';
        $this->data['view'] = 'ACE/painel';
    ...
    public function minhaConta()
    {
        ...
        $this->data['usuario'] = $this->ACE_model->getById($this->session->userdata('id'));
        $this->data['view'] = 'ACE/minhaConta';
        $this->load->view('tema/topo', $this->data);
    ...
    public function alterarSenha()
    {
        ...
        $current_user = $this->ACE_model->getById($this->session->userdata('id'));

        if (!$current_user) {
            $this->session->set_flashdata('error', 'Ocorreu um erro ao pesquisar usuário!');
            redirect(base_url() . 'index.php/ACE/minhaConta');
        }
        ...
        $result = $this->ACE_model->alterarSenha($senha);
    ...
    public function pesquisar()
    {
        ...
        $data['results'] = $this->ACE_model->pesquisar($termo);
        $this->data['produtos'] = $data['results']['produtos'];
        $this->data['servicos'] = $data['results']['servicos'];
        $this->data['os'] = $data['results']['os'];
        $this->data['clientes'] = $data['results']['clientes'];
        $this->data['view'] = 'ACE/pesquisa';
        $this->load->view('tema/topo', $this->data);
    ...
    public function verificarLogin()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->model('ACE_model');
            $user = $this->ACE_model->check_credentials($email);
    ...
    public function emitente()
    {
        ...
        $data['dados'] = $this->ACE_model->getEmitente();
        $data['view'] = 'ACE/emitente';
    ...
    public function cadastrarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url() . 'index.php/ACE/emitente');
            ...
            $retorno = $this->ACE_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email, $logo);
            if ($retorno) {
    ...
    public function editarEmitente()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->ACE_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf, $telefone, $email);
            if ($retorno) {
    ...
    public function editarLogo()
    {
        ...
        $retorno = $this->ACE_model->editLogo($id, $logo);
        if ($retorno) {
